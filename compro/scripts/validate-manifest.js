...
if (manifest.version !== '2.6.0') {
  console.error(`FAIL: expected version 2.6.0, got ${manifest.version}`);
  process.exit(1);
}
...
console.log('PASS: manifest is valid with version 2.6.0 and all 5 Layer 3 skills');
process.exit(0);
